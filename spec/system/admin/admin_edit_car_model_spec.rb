...
describe 'Admin edit car model' do
  ...
  it 'and does not allow saving with invalid data' do
    manufacture = create(:manufacture, name: 'Fiat')
    fuel_type = create(:fuel_type, name: 'Gasolina')
